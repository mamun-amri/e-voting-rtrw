        ...
        <div class="col-8">
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <div class="row">
                        <?php
                        $q = $this->db->query("SELECT * FROM kandidat ORDER BY 'ASC' ")->result();
                        foreach ($q as $key) :
                            $query = $this->db->query("SELECT COUNT(`pilihan`) AS num FROM vote WHERE `pilihan` = '$key->id'")->row();
                            // echo $query->num . "<br>";
                        ?>
                            <div class="col-md-4 alert alert-primary">
                                <h1 class="h6"><b>Nama</b></h1>
                                <h1 class="h6"><?= $key->nama ?></h1>
                            </div>
                            <div class="col-md-2 text-center alert alert-info">
                                <h1 class="h6"><b>Suara</b></h1>
                                <h1 class="h6"><?= $query->num ?></h1>
                            </div>
                        <?php
                        endforeach;
                        ?>
