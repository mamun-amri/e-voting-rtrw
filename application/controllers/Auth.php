...
class Auth extends CI_Controller
{
    ...
    public function userLogin()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($user) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-danger" >NIK Belum terdafat di sistem, hubungi panitia untuk mendaftarkan nik anda!</div>');
                redirect('user-login');
            }
        }
    }
    ...
    public function userLogout()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" >Terima kasih :)</div>');
        redirect('home');
    }
}
